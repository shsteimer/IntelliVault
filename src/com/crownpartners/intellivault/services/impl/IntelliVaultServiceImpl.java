...
import com.crownpartners.intellivault.filter.VaultImportFilter;
...
import com.crownpartners.intellivault.utils.FileUtils;
import com.crownpartners.intellivault.utils.IntelliVaultConstants;
...
public class IntelliVaultServiceImpl implements IntelliVaultService {
    ...
    public void vaultImport(final IntelliVaultCRXRepository repository, final IntelliVaultOperationConfig opConf,
        ...
        try {
            ...
            try {
                FileUtils.writeFile("com/crownpartners/intellivault/settings.xml", filterFile.getParentFile()
                        .getAbsoluteFile() + File.separator + "settings.xml");
                FileUtils.writeFile("com/crownpartners/intellivault/config.xml", filterFile.getParentFile()
